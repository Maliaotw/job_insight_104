...
@scheduler.scheduled_job(
    "cron",
    hour=CRAWLER_SCHEDULE_DAILY_CRAWL_HOUR,
    minute=CRAWLER_SCHEDULE_DAILY_CRAWL_MINUTE,
)
def scheduled_task():
    ...
    duckdb_manager.export_to_s3_parquet(table_name="news_jobs", s3_path="jobs.parquet")
